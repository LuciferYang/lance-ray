...
def _table(distances: list[float], ids: list[int]) -> pa.Table:
...
def test_take_top_k_selects_smallest_ascending() -> None:
...
def test_take_top_k_k_larger_than_rows_returns_all_sorted() -> None:
...
def test_merge_vector_search_results_global_topk() -> None:
