...
class TestLanceFragmentWriterCommitter:
    ...
    @pytest.mark.filterwarnings("ignore::DeprecationWarning")
    def test_fragment_writer_overwrite_mode_schema_change(
        self, tmp_path: Path
    ) -> None:
        ...
        (
            ...
            .map_batches(LanceFragmentWriter(str(tmp_path)))
            .write_datasink(LanceFragmentCommitter(str(tmp_path), mode="create"))
        )
        ...
        (
            ...
            .map_batches(LanceFragmentWriter(str(tmp_path), mode="overwrite"))
            .write_datasink(LanceFragmentCommitter(str(tmp_path), mode="overwrite"))
        )
